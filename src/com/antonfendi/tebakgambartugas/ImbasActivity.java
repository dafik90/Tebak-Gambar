...
public class ImbasActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_imbas);
    ...
    public void cekJawaban(View v){
		String  jawabanBenar = "IMBAS KETAMAKAN";
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.imbas, menu);
		return true;
	}
