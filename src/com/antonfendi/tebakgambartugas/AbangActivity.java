package com.antonfendi.tebakgambartugas;
...
public class AbangActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_abang);
    ...
    public void cekJawaban(View v){
		String  jawabanBenar = "ABANGKU SAYANG";
		...
		if (jawabanUser.equals(jawabanBenar)){			
			...
			Intent i = new Intent(getApplicationContext(),ImbasActivity.class);
			startActivity(i);
		}
		else{
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.abang, menu);
		return true;
	}
