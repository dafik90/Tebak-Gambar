...
public class SumpahActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sumpah);
    ...
    public void cekJawaban(View v){
		...
		if (jawabanUser.equals(jawabanBenar)){			
			...
			Intent i = new Intent(getApplicationContext(),TukangActivity.class);
			startActivity(i);
		}
		else{
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.sumpah, menu);
		return true;
	}
